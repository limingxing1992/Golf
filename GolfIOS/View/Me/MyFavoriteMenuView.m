//
//  MyFavoriteMenuView.m
//  GolfIOS
//
//  Created by 李明星 on 2016/12/15.
//  Copyright © 2016年 TSou. All rights reserved.
//

#import "MyFavoriteMenuView.h"

@interface MyFavoriteMenuView ()
...
@implementation MyFavoriteMenuView
- (instancetype)initWithFrame:(CGRect)frame{
    self = [super initWithFrame:frame];
    if (self) {
        self.backgroundColor = WHITECOLOR;
        [self createLayersWithTitles:@[@"球场", @"公告帖子"]];//创建标题指示器
        [self createTap];//添加手势
