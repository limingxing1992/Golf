//
//  MymessageGetPraiseViewController.m
//  GolfIOS
//
...
static NSString * MyMessageGetPraiseViewCellid = @"MyMessageGetPraiseViewCellid";
@interface MymessageGetPraiseViewController ()
/** 数据页数*/
...
@implementation MymessageGetPraiseViewController
...
- (void)viewDidLoad {
    ...
    [self.tableView registerClass:[MyMessageGetPraiseCell class] forCellReuseIdentifier:MyMessageGetPraiseViewCellid];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    MyMessageGetPraiseCell *communityCell = [tableView dequeueReusableCellWithIdentifier:MyMessageGetPraiseViewCellid]
    ;
