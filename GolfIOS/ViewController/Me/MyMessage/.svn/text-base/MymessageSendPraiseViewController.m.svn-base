//
//  MymessageSendPraiseViewController.m
//  GolfIOS
//
...
static NSString * MyMessagePraiseViewCellid = @"MyMessagePraiseViewCellid";
@interface MymessageSendPraiseViewController ()
/** 数据页数*/
...
@implementation MymessageSendPraiseViewController
...
- (void)viewDidLoad {
    ...
    [self.tableView registerClass:[TSOHomeCommunityTableViewCell class] forCellReuseIdentifier:MyMessagePraiseViewCellid];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    MyMessageSendPraiseCell *communityCell = [tableView dequeueReusableCellWithIdentifier:MyMessagePraiseViewCellid]
    ;
