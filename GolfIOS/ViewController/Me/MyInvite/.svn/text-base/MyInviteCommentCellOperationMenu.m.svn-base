//
//  MyInviteCommentCellOperationMenu.m
//  GolfIOS
//
...
@implementation MyInviteCommentCellOperationMenu
...
- (void)setup
{
    ...
    _likeButton = [self creatButtonWithTitle:@"电话" image:[UIImage imageNamed:@"classify187"] selImage:[UIImage imageNamed:@""] target:self selector:@selector(likeButtonClicked)];
