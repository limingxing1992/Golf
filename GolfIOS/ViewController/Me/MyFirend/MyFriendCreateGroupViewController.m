//
//  MyFriendCreateGroupViewController.m
//  GolfIOS
//
...
#import "MyFriendCreateGroupViewController.h"

@interface MyFriendCreateGroupViewController ()
...
@implementation MyFriendCreateGroupViewController
...
//    [ShareBusinessManager.userManager postCreateFriendAddWithParameters:@{@"groupName":_groupTf.text} friendArys:friendsId success:^(id responObject) {
//        [SVProgressHUD showSuccessWithStatus:@"创建成功"];
//        dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(1.2 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
//            [GOLFNotificationCenter postNotificationName:@"updateFriendGroupList" object:nil];//发送通知刷新分组好友界面
//            [weakself.navigationController popViewControllerAnimated:YES];
