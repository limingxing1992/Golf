...
@interface ScroeChartViewController ()
<
    UITableViewDelegate,
...
/** 切换周和总*/
@property (nonatomic, strong) ScoreSegement *menu;
/** 个人排行信息*/
...
@implementation ScroeChartViewController
...
- (void)loadDataWithRet:(BOOL)ret{
    ...
    NSDictionary *dict = @{@"currentPage":[NSNumber numberWithInteger:_currentPage],
                           @"pageSize":PAGESIZE,
                           @"flag":[NSNumber numberWithInteger:_currentSelectIndex + 1]};
    [ShareBusinessManager.chartsManager postChartsScoreListParameters:dict
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ChartsTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"scoreCell"];
...
- (UITableView *)tableView{
    if (!_tableView) {
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 45, SCREEN_WIDTH, SCREEN_HEIGHT - NaviBar_HEIGHT - 92.5 - 45 - 75)];
        ...
        [_tableView registerClass:[ChartsTableViewCell class] forCellReuseIdentifier:@"scoreCell"];
        GOLFWeakObj(self);
        //下拉刷新
...
- (ScoreSegement *)menu{
    if (!_menu) {
        _menu = [[ScoreSegement alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, 45)];
        GOLFWeakObj(self);
