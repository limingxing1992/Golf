...
@interface StrarChartsViewController ()
<
    UITableViewDelegate,
...
@implementation StrarChartsViewController
...
- (void)loadDataWithRet:(BOOL)ret{
    ...
    NSDictionary *dict = @{@"currentPage":[NSNumber numberWithInteger:_currentPage],
                           @"pageSize":PAGESIZE};
    [ShareBusinessManager.chartsManager postChartsHotRankListParameters:dict
